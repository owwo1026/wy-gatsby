  ...
  return (
    <div id="#about">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-8 gap-8 py-12 items-center">
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <p className="md:text-body-lg text-body-md font-light text-neutral-700 text-justify">
              我們是間年輕公司，由兩位懷抱著熱忱和想法的年輕設計師於2022年攜手創立。維域（維繫各元素空間及場域相互串聯而產生良好效應）體現了我們對空間的期待，再結合專業的施工團隊下為屋主打造專屬的空間及居所！
            </p>
            <p className="md:text-body-lg text-body-md font-light text-neutral-700 text-justify">
              對我們來說每個設計過程中皆是獨特的，使用者的不同便賦予空間意義的差異，聆聽、溝通，並給予專業的建議，連繫個人想法、觀感與尺度美學間所構成獨有的空間和場域，便是維域。
            </p>
          </div>
