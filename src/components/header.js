...
// import Logo from "../images/logos/wy-logo-2.png";
          ...
          <div className="flex flex-row gap-6">
            <div className="md:flex hidden flex-row gap-4 items-center">
              {navigation.map((item) => (
                <a
                  href={item.href}
                  className="text-body-sm font-medium text-neutral-700 hover:text-primary-600 px-4 hover:transform hover:scale-110"
                >
                  {item.name}
                </a>
              ))}
